...
!function(a){var b=a.document,c=a.navigator,d=c.msPointerEnabled,e={start:d?"MSPointerDown":"touchstart",move:d?"MSPointerMove":"touchmove",end:d?"MSPointerUp":"touchend"},f=b.createElement("div").style,g=function(){for(var b,a="t,webkitT,MozT,msT,OT".split(","),c=0,d=a.length;d>c;c++)if(b=a[c]+"ransform",b in f)return a[c].substr(0,a[c].length-1);return!1}(),h=function(a){return""===g?a:(a=a.charAt(0).toUpperCase()+a.substr(1),g+a)},i=h("transition"),j=function(){return"webkit"==g||"O"===g?g.toLowerCase()+"TransitionEnd":"transitionend"}(),k=function(a,b,c){var d=this,e=function(){a.transitionTimer&&clearTimeout(a.transitionTimer),a.transitionTimer=null,a.removeEventListener(j,f,!1)},f=function(){e(),c&&c.call(d)};e(),a.addEventListener(j,f,!1),a.transitionTimer=setTimeout(f,b+100)},l=function(a,c){this.ct=a?"string"==typeof a?b.querySelector(a):a:b.body,c=c||{},this.options=c,"undefined"==typeof c.threshold&&(c.threshold=80),"undefined"==typeof c.dragDownThreshold&&(c.dragDownThreshold=c.threshold),"undefined"==typeof c.dragUpThreshold&&(c.dragUpThreshold=c.threshold),this._events={},this._draggable=!0,this.ct.addEventListener(e.start,this,!1)};l.prototype={STATUS:{"default":"default",prepare:"prepare",load:"load"},_createDragDownRegion:function(){return this._removeDragDownRegion(),this.header=b.createElement("div"),this.header.style.cssText="position:relative;top:0;left:0;margin:0;padding:0;overflow:hidden;width:100%;height:0px;",this.header.className=this.options.dragDownRegionCls||"",this._touchCoords.status=this._processStatus("down",0,null,!0),this.ct.insertBefore(this.header,this.ct.children[0]),this.header},_removeDragDownRegion:function(){this.header&&(this.ct.removeChild(this.header),this.header=null)},_createDragUpRegion:function(){return this._removeDragUpRegion(),this.footer=b.createElement("div"),this.footer.style.cssText="position:relative;bottom:0;left:0;margin:0;padding:0;overflow:hidden;width:100%;height:0px;",this.footer.className=this.options.dragUpRegionCls||"",this._touchCoords.status=this._processStatus("up",0,null,!0),this.ct.appendChild(this.footer),this.footer},_removeDragUpRegion:function(){this.footer&&(this.ct.removeChild(this.footer),this.footer=null)},_processDragDownHelper:function(a){var b=this.options,c=b.dragDownHelper;!b.preventDragHelper&&c&&(this.header.innerHTML=c.call(this,a))},_processDragUpHelper:function(a){var b=this.options,c=b.dragUpHelper;!b.preventDragHelper&&c&&(this.footer.innerHTML=c.call(this,a))},_processStatus:function(a,b,c,d){var g,i,e=this.options,f=this.STATUS,h=c;return a&&(i=a.charAt(0).toUpperCase()+a.substr(1),g=b>e["drag"+i+"Threshold"],g||c==f.default?d&&g&&c!=f.prepare?(this["_processDrag"+i+"Helper"].call(this,f.prepare),this._fireEvent("drag"+i+"Prepare"),h=f.prepare):!d&&g&&c!=f.load&&(this["_processDrag"+i+"Helper"].call(this,f.load),this._fireEvent("drag"+i+"Load"),h=f.load):(this["_processDrag"+i+"Helper"].call(this,f.default),this._fireEvent("drag"+i+"Default"),h=f.default)),h},_onTouchStrat:function(c){this.ct.removeEventListener(e.move,this,!1),this.ct.removeEventListener(e.end,this,!1);var f=b.body,g=this.ct===f?a.pageYOffset||a.scrollY||b.documentElement.scrollTop:this.ct.scrollTop;!this._draggable||this.options.disableDragDown===!0&&this.options.disableDragUp===!0||this._fireEvent("beforeDrag")===!1||(this._draggable=!1,this.ct.addEventListener(e.move,this,!1),this.ct.addEventListener(e.end,this,!1),this._touchCoords={},this._touchCoords.startY=d?c.screenY:c.touches[0].screenY,this._touchCoords.startScrollY=g)},_onTouchMove:function(b){var o,p,c=this.ct,e=this.header,f=this.footer,g=this.options,h=a.innerHeight,i=c.scrollHeight,j=this._touchCoords,k=j.startScrollY,l=j.blockY,m=j.startY,n=d?b.screenY:b.touches[0].screenY;"undefined"==typeof j.canDragDown&&(j.canDragDown=g.disableDragDown!==!0&&n>m&&0>=k,"off"==this.options.downToggle&&(j.canDragDown=!1)),"undefined"==typeof j.canDragUp&&(j.canDragUp=g.disableDragUp!==!0&&m>n&&k+h>=i),j.canDragDown&&j.dragUp!==!0&&(j.dragDown||0>m-n+k)?(b.preventDefault(),j.dragDown=!0,e||(e=this._createDragDownRegion()),"undefined"==typeof l&&(j.blockY=l=n),o=n-l,o=o>0?o:0,p=o-g.dragDownThreshold,p>100?o=g.dragDownThreshold+75+.25*(p-100):p>50&&(o=g.dragDownThreshold+50+.5*(p-50)),e.style.height=o+"px",j.status=this._processStatus("down",o,j.status,!0)):j.canDragUp&&j.dragDown!==!0&&(j.dragUp||m-n+k+h>i)?(b.preventDefault(),j.dragUp=!0,f||(f=this._createDragUpRegion()),"undefined"==typeof l&&(j.blockY=l=n),o=l-n,o=o>0?o:0,p=o-g.dragUpThreshold,p>100?o=g.dragUpThreshold+75+.2*(p-100):p>50&&(o=g.dragUpThreshold+50+.5*(p-50)),c.scrollTop=k+o,f.style.height=o+"px",j.status=this._processStatus("up",o,j.status,!0)):j.blockY=n},_onTouchEnd:function(){this.ct.removeEventListener(e.move,this,!1),this.ct.removeEventListener(e.end,this,!1),this._translate()},_translate:function(){var d,e,f,g,j,l,m,a=this,b=a.options,c=a._touchCoords,h=200,n=function(){c.status=a._processStatus(d,f,c.status,!1),d&&c.status===a.STATUS.load?"down"==d?a._removeDragUpRegion():"up"==d&&a._removeDragDownRegion():(a._removeDragDownRegion(),a._removeDragUpRegion(),a._touchCoords=null,a._draggable=!0)};c&&(d=c.dragDown?"down":c.dragUp?"up":null,d?(e="down"==d?a.header:a.footer,f=e.offsetHeight,l=d.charAt(0).toUpperCase()+d.substr(1),m=b["drag"+l+"Threshold"],g=!b.preventDragHelper&&f>m?m:0,j=Math.ceil((f-g)/m*h),j=j>h?h:j,k(e,j,n),e.style[i]="height "+j+"ms",setTimeout(function(){e.style.height=g+"px"},0)):n())},reset:function(){this._translate()},on:function(a,b){this._events[a]||(this._events[a]=[]),this._events[a].push(b)},off:function(a,b){this._events[a]&&this._events[a].every(function(c,d){return c===b?(this._events[a].splice(d,1),!1):void 0})},_fireEvent:function(a,b){var d,c=this;return c._events[a]&&c._events[a].forEach(function(a){d=a.apply(c,b||[])}),d},setDragDownDisabled:function(a){this.options.disableDragDown=a},setDragUpDisabled:function(a){this.options.disableDragUp=a},handleEvent:function(a){switch(a.type){case e.start:this._onTouchStrat(a);break;case e.move:this._onTouchMove(a);break;case e.end:this._onTouchEnd(a)}},destroy:function(){this.destroyed||(this.destroyed=!0,this._removeDragDownRegion(),this._removeDragUpRegion(),this.ct.removeEventListener(e.start,this,!1),this.ct.removeEventListener(e.move,this,!1),this.ct.removeEventListener(e.end,this,!1),this.ct=null)}},f=null,a.DragLoader=l}(window);
var APP = {
    data: {
        config:{
            noimg: 0
